...
CREATE TABLE `parameter`  (
  `group_size` int(11) NOT NULL COMMENT '小组人员数',
  `teacher_evaluation` int(11) NOT NULL COMMENT '评价模版教师评价比重',
  `self_evaluation` int(11) NOT NULL COMMENT '评价模版自评比重',
  `group_evaluation` int(11) NOT NULL COMMENT '评价模版组员评价比重',
...
CREATE TABLE `task`  (
  ...
  `task_content_pt` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'ppt要求',
  `task_content_vd` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'video要求',
